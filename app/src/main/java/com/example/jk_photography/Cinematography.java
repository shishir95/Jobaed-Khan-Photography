...
public class Cinematography extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl("https://jobaedkhan.com/cinematography/");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.nav_home) {
            //do somthing
            Intent intent = new Intent(Cinematography.this,
                    MainActivity.class);
